...
@Provider
public class WifiExceptionMapper implements ExceptionMapper<WifiException> {
    @Inject TelemetriaLogger telemetriaLogger;
    @Context ContainerRequestContext requestContext;
    @Override public Response toResponse(WifiException exception) {
        TelemetriaExceptionSupport.registrar(telemetriaLogger, "wifi", "domain_exception", requestContext, exception);
